...
| **T-001r3** | **COMPLETE (Jul 8, ~15:20 UTC) — ENVELOPE PASS.** Endpoint (from results.json): step 10000, co/cross **41,811.71**, Fiedler 1.935e-4, val 0.4017 → **0.596% rel dev vs r2's 41,564** (three-way same-seed record tolerated 5–10% at matched steps). Config verified like-for-like (seed 42, n=8, identity+Steersman, March-era code). Fourth mutually consistent same-seed run; Paper 4 tab:reproducibility 4th-run dated edit queued | `results/T-001-full-r3/` (config+results committed, r2 convention; full 8,979-file checkpoint payload local) |
