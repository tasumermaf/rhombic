...
**Venue:** KDD 2025  
**Date:** 2025  
**Tags:** contrastive, graph

## Program assessments

### From `C:\falco\rhombic\orvad-research-non-english-lora.md`

**Verdict:** Structure-aware contrastive learning for cross-graph transfer, not within adapter internals · **Threat:** None · **Confidence:** HIGH (located and characterized)
...
---
**GraphLoRA** (KDD 2025): Structure-aware contrastive learning for cross-graph transfer
---
