...
recall-and-combination task (15 episodes $\times$ 8 probes $\times$ 3 models
$\times$ 3 regimes $= 1{,}080$ probes). Pooled numeric-corruption rate
...
are local, span $4$B--$30$B parameters, and duplicate one family
(\texttt{qwen3}). Generation is temperature-$0$ single-sample, so we report no
