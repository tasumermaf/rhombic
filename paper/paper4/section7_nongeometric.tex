...
\begin{enumerate}
  ...
  \item \textbf{Spectral attractor} (no contrastive).
    ...
    Co/cross: ${\sim}1$:1. Fiedler: $0.084$--$0.102$.
...
spectral attractor represents a stable equilibrium at Fiedler
$\approx 0.09$; the collapse regime represents a destructive
interaction where the contrastive loss overwhelms the spectral loss
and drives connectivity to zero. The spectral attractor is the
bridge's resting state; the collapse regime is the bridge's failure
mode under incoherent programming.

Second, Regimes~2 and~3 are structurally similar (both near
Fiedler~$\approx 0.09$, both with co/cross near unity) but
mechanistically different. The spectral attractor achieves
connectivity through spectral loss alone. Hierarchical coherence
achieves similar connectivity through a different pathway---master
bridge with contrastive loss---and develops weak directionality
that the spectral attractor does not. The regimes are adjacent in
