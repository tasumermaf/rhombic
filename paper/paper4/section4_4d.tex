...
channel size $s = 3$ ($24 / 8$). Three same-seed runs were conducted
...
fresh same-seed relaunch, 7{,}100~steps), and T-001r2 (complete,
10{,}000~steps).
...
\subsection{Reproducibility: Three Same-Seed Runs}
\label{sec:reproducibility}

Three runs of the $n = 8$ tesseract contrastive experiment were
...
(10{,}000~steps). The three trajectories therefore constitute
independent same-seed replicates, one of them partially recovered.

\begin{table}[H]
\centering
\caption{Reproducibility of tesseract contrastive training: pairwise
  trajectory agreement between three same-seed runs at matched
