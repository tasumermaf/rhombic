...
%   4. OCTAHEDRAL HOLE: O-001 473,622:1 and its FO-001 262,920:1 bracket are
%      Hermes-ONLY — the n=4 endpoint of the "inverse-n" ordering (474K>70K>42K)
%      and the Regime-1 span have ZERO local evidence. Re-fetch from Hermes or
%      re-run FO-001 locally before the octahedral headline can be trusted.
