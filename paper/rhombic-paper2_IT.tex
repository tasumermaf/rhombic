...
strutturati (intervallo, media e deviazione standard omessi al confine
del corpus) derivati da un protocollo di traslitterazione fisso applicato a
...
assegnato:
\begin{itemize}
  \item $67 \to$ vertice 7: un arco è un multiplo di $67$
  \item $29 \to$ vertice 0: un arco è un multiplo di $29$
  \item $19 \to$ vertice 4: un arco è un multiplo di $19$
  \item $17 \to$ vertice 3: un arco è un multiplo di $17$
  \item $11 \to$ vertice 5: un arco è un multiplo di $11$
\end{itemize}
...
su questa architettura ``TeLoRA'' sono riportati nell'articolo
